...
session_start();
    ...
    // $sql="select * from other_question q WHERE paper_id='".$testid."'";
    ...
    //     $qid = $result['question_id'];
        ...
        $sql2="select SUM(ans) as totalScore from test_attempt INNER JOIN other_question o
                ON o.question_id=quid  WHERE paper_id='".$testid."' AND stdid='".$stdid."'";
        ...
        $right_answer = $result['totalScore'];
    ...
    //else insert his scores into the db
        ...
        echo "<br><br>
            <div class='jumbotron'>
                    <h3 class='text-info'><b>Student grade was submitted successfully. Student can now proceed to the next station.</b></h3>
                        <a href='' class='pull-right btn btn-success' id='tryAgain' >Close <span class='glyphicon glyphicon-log-out'></span></a>
                 </div>
        ";
