...
?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ResetExam<small>Module</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">ResetExam</li>
            </ol>
        </section>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="box box-solid">
                        <?php
                        echo $test ->getTestMenu($idm,'reset_exam.php?id=');
                        ?>
                ...
                <div class="col-md-2">
                    <div class="box box-solid">
                    <?php
                        echo $test ->getBatchMenu($idm , 'reset_exam.php',$batch);
                        ?>
                ...
                <div class="col-md-7">
                    ...
                    <div class="box box-primary" style="width:100%;overflow:scroll">
                        <!-- /.box-header -->
                        <?php
                        echo $test ->resetExams($idm,$batch);
                        ?>
...
<div class="modal fade" id="reset_modal" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="delete">
    <div class="modal-dialog modal-md mdls" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <h4><code id="confirm">Resetting this exam (for <span id="name"></span>) will delete all activities relating to this exam and student(s). Are you sure you want to reset this exam?</code></h4>
            ...
            <div class="modal-footer">
                <button class="btn btn-md btn-danger pull-left" id="ok_reset">Submit</button>
