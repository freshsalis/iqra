        ...
        if(in_array($ext, $allowedExtensions)) {
            ...
            if($file_size < 1000) {
                ...
                if($isUploaded) {
                    ...
                    $expectedColumns = [ "MATRIC NUMBER","SURNAME"	,"OTHER NAMES",	"DEPARTMENT"];
                    ...
                    if (count(($expectedColumns))  === count($headerRow)) {
                        ...
                        while(($data = fgetcsv($handle,1000,',')) !== FALSE){
                            if($i >0){
                                ...
                                $dept = clean($data[3]);
                                $sql_select = " SELECT * FROM schedule_student WHERE exam_id ='$test_id' 
                                        AND reg_no = '$regno' ";
                                ...
                                if ($count>0) {
                                    ...
                                    $sql_check = " UPDATE schedule_student SET reg_no='$regno',surname='$surname',
                                        othername='$othername',dept='$dept' WHERE exam_id ='".$test_id."' 
                                        AND reg_no = '$regno' ";
