    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">View Questiont</li>
            </ol>
        </section>
...
<div class="modal fade" id="delete" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="delete">
    <div class="modal-dialog modal-sm mdls" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <small><b><span id="confirm">Are you sure you want to delete this Question?</span></b></small>
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="del_all_question_modal" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="delete">
    <div class="modal-dialog modal-md mdls" role="document">
        <div class="modal-content">
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <button class="btn btn-md btn-danger pull-left" id="ok_delete_question">Submit</button>
