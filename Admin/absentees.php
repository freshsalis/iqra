...
?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Absentees<small>Module</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">Absentees</li>
            </ol>
        </section>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="box box-solid">
                        <?php
                        echo $test ->getTestMenu($idm,'absentees.php?id=');
                        ?>
                ...
                <div class="col-md-2">
                    <div class="box box-solid">
                    <?php
                        echo $test ->getBatchMenu($idm , 'absentees.php',$batch);
                        ?>
